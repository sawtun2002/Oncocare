...
export const seedEquipmentPosts = [
  {
    id: 1,
    title: "Varian TrueBeam Radiation Therapy System",
    description: "Advanced image-guided radiotherapy system designed to deliver high-precision stereotactic radiosurgery and radiotherapy for targeted cancer treatment.",
  ...
  {
    id: 2,
    title: "GE Revolution Apex CT Scanner",
    description: "Ultra-fast 256-slice CT scanner with deep learning image reconstruction, providing high-resolution oncology imaging with reduced radiation dose.",
  ...
  {
    id: 3,
    title: "Elekta Unity MR-Linac",
    description: "High-field 1.5T MRI integrated with a linear accelerator, enabling real-time visualization and adaptive radiation therapy during treatment delivery.",
    category: "Radiotherapy",
    manufacturer: "Elekta",
    model: "Unity 1.5T",
    imageUrl: "https://images.unsplash.com/photo-1581595220892-6e8e893d6db4?auto=format&fit=crop&w=800&q=80",
    isFeatured: true,
    isActive: true,
    createdBy: 1,
  ...
  {
    id: 4,
    title: "Da Vinci Xi Surgical Robotic System",
    description: "Multi-quadrant robotic surgical platform providing 3D HD visualization and wrist-articulated instruments for minimally invasive oncology surgeries.",
  ...
  {
    id: 5,
    title: "Thermo Fisher Ion Torrent Genexus Sequencer",
    description: "Next-generation sequencing platform delivering automated genomic profiling and biomarker discovery for precision cancer therapy.",
    category: "Genomics & Laboratory",
    manufacturer: "Thermo Fisher Scientific",
    model: "Ion Torrent Genexus",
