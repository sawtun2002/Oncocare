...
export function BackToTop() {
  ...
  return (
    <button
      ...
      title="Back to top"
      className={`cursor-pointer fixed bottom-5 right-5 z-40 flex h-11 w-11 items-center justify-center rounded-full bg-serenity-700 text-xl text-white shadow-lg shadow-serenity-900/20 transition duration-200 hover:-translate-y-1 hover:bg-serenity-900 focus:outline-none focus:ring-2 focus:ring-serenity-300 focus:ring-offset-2 sm:bottom-7 sm:right-7 ${
