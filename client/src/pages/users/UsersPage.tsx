...
import { createStaffUser, listUsers, type StaffRole, type StaffUserInput } from "../../api/users";
...
function isStaff(user: User): user is User & { role: StaffRole } {
...
export function UsersPage() {
  ...
  const createMutation = useMutation({
    mutationFn: (input: StaffUserInput) => createStaffUser(input),
